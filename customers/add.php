...
<form action="add.php" method="post">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="number" class="form-control" name="customer['zip_code']">
    </div>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="number" class="form-control" name="customer['phone']">
    </div>
    
    <div class="form-group col-md-2">
      <label for="campo3">Celular</label>
      <input type="number" class="form-control" name="customer['mobile']">
    </div>
