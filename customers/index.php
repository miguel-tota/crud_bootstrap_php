...
<?php foreach ($customers as $customer) : ?>
	<tr>
		...
		<td class="actions text-right">
			...
			<a href="edit.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-default"><i class="fa fa-pencil"></i> Editar</a>
			<a href="#" class="btn btn-sm" data-toggle="modal" data-target="#delete-modal" data-customer="<?php echo $customer['id']; ?>">
